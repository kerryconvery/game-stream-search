...
using GameStreamSearch.Api.Providers;

namespace GameStreamSearch.Api.Services
{
    public class StreamService
    {
        ...
        public Task<ChannelDto> GetChannel(string channelName, StreamPlatformType streamingPlatform)
        {
            var streamProvider = streamProviders[streamingPlatform];

            return streamProvider.GetStreamerChannel(channelName);
        }
    }
}
